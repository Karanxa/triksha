...
import { useGeraidScan } from "./geraid-engine/hooks/useGeraidScan";
import { GeraidChatMessages } from "./geraid-engine/components/GeraidChatMessages";
...
interface GeraidChatbotProps {
  onFingerprint?: (results: any) => void;
}

export const GeraidChatbot = ({ onFingerprint }: GeraidChatbotProps) => {
  ...
  return (
    <div className="space-y-4">
      <GeraidChatMessages messages={messages} isLoading={isLoading} />
